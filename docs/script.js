...
const album = [
  ...
  { src: 'aya.jpg', msg: 'Happy  birthday!!<br>いつも楽しい配信ありがとう!!<br>いろんな事を一緒にもっともーっと楽しんでいこうね!! 作成者 妖月' },
  { src: 'kanata.jpg', msg: 'まのママ、誕生日おめでとう🎉<br>初めて出会った時はまさかここまで深い関係なるとは思わんかったな<br>でも、色々助けてくれてありがとう<br>まだまだ未熟なオレだけど、またこれからも仲良くしてくれると嬉しいな<br>これからもよろしくな！！！ 作成者 鎌鼬叶多' },
  { src: 'suama.jpg', msg: 'お誕生日おめでとうございます！<br>ささやかながらお花を贈らせていただきます。作成者　すあま'}
];
